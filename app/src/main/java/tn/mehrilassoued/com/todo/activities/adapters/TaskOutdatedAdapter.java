...
public class TaskOutdatedAdapter extends RecyclerView
        .Adapter<TaskOutdatedAdapter
        .DataObjectHolder> {
    private static String LOG_TAG = "TaskOutdatedAdapter";
    ...
    public TaskOutdatedAdapter(List<Task> tasks, Context context) {
        this.tasks = tasks;
    ...
    public static void setTasks(List<Task> tasks) {
        TaskOutdatedAdapter.tasks = tasks;
    }
}